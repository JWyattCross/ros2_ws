...
enum
{
  uf_interfaces__action__Defend_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  uf_interfaces__action__Defend_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Defend in the package uf_interfaces.
typedef struct uf_interfaces__action__Defend_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  uf_interfaces__action__Defend_SendGoal_Request__Sequence request;
  uf_interfaces__action__Defend_SendGoal_Response__Sequence response;
} uf_interfaces__action__Defend_SendGoal_Event;

// Struct for a sequence of uf_interfaces__action__Defend_SendGoal_Event.
typedef struct uf_interfaces__action__Defend_SendGoal_Event__Sequence
{
...
enum
{
  uf_interfaces__action__Defend_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  uf_interfaces__action__Defend_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Defend in the package uf_interfaces.
typedef struct uf_interfaces__action__Defend_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  uf_interfaces__action__Defend_GetResult_Request__Sequence request;
  uf_interfaces__action__Defend_GetResult_Response__Sequence response;
} uf_interfaces__action__Defend_GetResult_Event;

// Struct for a sequence of uf_interfaces__action__Defend_GetResult_Event.
typedef struct uf_interfaces__action__Defend_GetResult_Event__Sequence
{
