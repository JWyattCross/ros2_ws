...
inline std::string to_yaml(const TaskAssign_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use uf_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const uf_interfaces::srv::TaskAssign_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  uf_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use uf_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const uf_interfaces::srv::TaskAssign_Event & msg)
{
  return uf_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<uf_interfaces::srv::TaskAssign_Event>()
{
  return "uf_interfaces::srv::TaskAssign_Event";
}

template<>
inline const char * name<uf_interfaces::srv::TaskAssign_Event>()
{
  return "uf_interfaces/srv/TaskAssign_Event";
}

template<>
struct has_fixed_size<uf_interfaces::srv::TaskAssign_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<uf_interfaces::srv::TaskAssign_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<uf_interfaces::srv::TaskAssign_Request>::value && has_bounded_size<uf_interfaces::srv::TaskAssign_Response>::value> {};

template<>
struct is_message<uf_interfaces::srv::TaskAssign_Event>
  : std::true_type {};
