...
uf_interfaces__action__Defend_Goal__create(void)
{
...
uf_interfaces__action__Defend_Result__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
uf_interfaces__action__Defend_Feedback__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
uf_interfaces__action__Defend_SendGoal_Request__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
uf_interfaces__action__Defend_SendGoal_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
uf_interfaces__action__Defend_SendGoal_Event__init(uf_interfaces__action__Defend_SendGoal_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    uf_interfaces__action__Defend_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!uf_interfaces__action__Defend_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    uf_interfaces__action__Defend_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!uf_interfaces__action__Defend_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    uf_interfaces__action__Defend_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
void
uf_interfaces__action__Defend_SendGoal_Event__fini(uf_interfaces__action__Defend_SendGoal_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  uf_interfaces__action__Defend_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  uf_interfaces__action__Defend_SendGoal_Response__Sequence__fini(&msg->response);
}

bool
uf_interfaces__action__Defend_SendGoal_Event__are_equal(const uf_interfaces__action__Defend_SendGoal_Event * lhs, const uf_interfaces__action__Defend_SendGoal_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!uf_interfaces__action__Defend_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!uf_interfaces__action__Defend_SendGoal_Response__Sequence__are_equal(
...
bool
uf_interfaces__action__Defend_SendGoal_Event__copy(
  const uf_interfaces__action__Defend_SendGoal_Event * input,
  uf_interfaces__action__Defend_SendGoal_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!uf_interfaces__action__Defend_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!uf_interfaces__action__Defend_SendGoal_Response__Sequence__copy(
...
uf_interfaces__action__Defend_SendGoal_Event *
uf_interfaces__action__Defend_SendGoal_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  uf_interfaces__action__Defend_SendGoal_Event * msg = (uf_interfaces__action__Defend_SendGoal_Event *)allocator.allocate(sizeof(uf_interfaces__action__Defend_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(uf_interfaces__action__Defend_SendGoal_Event));
  bool success = uf_interfaces__action__Defend_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
uf_interfaces__action__Defend_SendGoal_Event__destroy(uf_interfaces__action__Defend_SendGoal_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    uf_interfaces__action__Defend_SendGoal_Event__fini(msg);
...
bool
uf_interfaces__action__Defend_SendGoal_Event__Sequence__init(uf_interfaces__action__Defend_SendGoal_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  uf_interfaces__action__Defend_SendGoal_Event * data = NULL;

  if (size) {
    data = (uf_interfaces__action__Defend_SendGoal_Event *)allocator.zero_allocate(size, sizeof(uf_interfaces__action__Defend_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = uf_interfaces__action__Defend_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        uf_interfaces__action__Defend_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
uf_interfaces__action__Defend_SendGoal_Event__Sequence__fini(uf_interfaces__action__Defend_SendGoal_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      uf_interfaces__action__Defend_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
uf_interfaces__action__Defend_SendGoal_Event__Sequence *
uf_interfaces__action__Defend_SendGoal_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  uf_interfaces__action__Defend_SendGoal_Event__Sequence * array = (uf_interfaces__action__Defend_SendGoal_Event__Sequence *)allocator.allocate(sizeof(uf_interfaces__action__Defend_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = uf_interfaces__action__Defend_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
uf_interfaces__action__Defend_SendGoal_Event__Sequence__destroy(uf_interfaces__action__Defend_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    uf_interfaces__action__Defend_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
uf_interfaces__action__Defend_SendGoal_Event__Sequence__are_equal(const uf_interfaces__action__Defend_SendGoal_Event__Sequence * lhs, const uf_interfaces__action__Defend_SendGoal_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!uf_interfaces__action__Defend_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
uf_interfaces__action__Defend_SendGoal_Event__Sequence__copy(
  const uf_interfaces__action__Defend_SendGoal_Event__Sequence * input,
  uf_interfaces__action__Defend_SendGoal_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(uf_interfaces__action__Defend_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    uf_interfaces__action__Defend_SendGoal_Event * data =
      (uf_interfaces__action__Defend_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!uf_interfaces__action__Defend_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          uf_interfaces__action__Defend_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!uf_interfaces__action__Defend_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
uf_interfaces__action__Defend_GetResult_Request__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
uf_interfaces__action__Defend_GetResult_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
bool
uf_interfaces__action__Defend_GetResult_Event__init(uf_interfaces__action__Defend_GetResult_Event * msg)
{
  if (!msg) {
    return false;
  }
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    uf_interfaces__action__Defend_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!uf_interfaces__action__Defend_GetResult_Request__Sequence__init(&msg->request, 0)) {
    uf_interfaces__action__Defend_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!uf_interfaces__action__Defend_GetResult_Response__Sequence__init(&msg->response, 0)) {
    uf_interfaces__action__Defend_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
void
uf_interfaces__action__Defend_GetResult_Event__fini(uf_interfaces__action__Defend_GetResult_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  uf_interfaces__action__Defend_GetResult_Request__Sequence__fini(&msg->request);
  // response
  uf_interfaces__action__Defend_GetResult_Response__Sequence__fini(&msg->response);
}

bool
uf_interfaces__action__Defend_GetResult_Event__are_equal(const uf_interfaces__action__Defend_GetResult_Event * lhs, const uf_interfaces__action__Defend_GetResult_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!uf_interfaces__action__Defend_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!uf_interfaces__action__Defend_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
...
bool
uf_interfaces__action__Defend_GetResult_Event__copy(
  const uf_interfaces__action__Defend_GetResult_Event * input,
  uf_interfaces__action__Defend_GetResult_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!uf_interfaces__action__Defend_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!uf_interfaces__action__Defend_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
uf_interfaces__action__Defend_GetResult_Event *
uf_interfaces__action__Defend_GetResult_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  uf_interfaces__action__Defend_GetResult_Event * msg = (uf_interfaces__action__Defend_GetResult_Event *)allocator.allocate(sizeof(uf_interfaces__action__Defend_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(uf_interfaces__action__Defend_GetResult_Event));
  bool success = uf_interfaces__action__Defend_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
uf_interfaces__action__Defend_GetResult_Event__destroy(uf_interfaces__action__Defend_GetResult_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    uf_interfaces__action__Defend_GetResult_Event__fini(msg);
...
bool
uf_interfaces__action__Defend_GetResult_Event__Sequence__init(uf_interfaces__action__Defend_GetResult_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  uf_interfaces__action__Defend_GetResult_Event * data = NULL;

  if (size) {
    data = (uf_interfaces__action__Defend_GetResult_Event *)allocator.zero_allocate(size, sizeof(uf_interfaces__action__Defend_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = uf_interfaces__action__Defend_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        uf_interfaces__action__Defend_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
uf_interfaces__action__Defend_GetResult_Event__Sequence__fini(uf_interfaces__action__Defend_GetResult_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      uf_interfaces__action__Defend_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
uf_interfaces__action__Defend_GetResult_Event__Sequence *
uf_interfaces__action__Defend_GetResult_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  uf_interfaces__action__Defend_GetResult_Event__Sequence * array = (uf_interfaces__action__Defend_GetResult_Event__Sequence *)allocator.allocate(sizeof(uf_interfaces__action__Defend_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = uf_interfaces__action__Defend_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
uf_interfaces__action__Defend_GetResult_Event__Sequence__destroy(uf_interfaces__action__Defend_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    uf_interfaces__action__Defend_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
uf_interfaces__action__Defend_GetResult_Event__Sequence__are_equal(const uf_interfaces__action__Defend_GetResult_Event__Sequence * lhs, const uf_interfaces__action__Defend_GetResult_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!uf_interfaces__action__Defend_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
uf_interfaces__action__Defend_GetResult_Event__Sequence__copy(
  const uf_interfaces__action__Defend_GetResult_Event__Sequence * input,
  uf_interfaces__action__Defend_GetResult_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(uf_interfaces__action__Defend_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    uf_interfaces__action__Defend_GetResult_Event * data =
      (uf_interfaces__action__Defend_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!uf_interfaces__action__Defend_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          uf_interfaces__action__Defend_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!uf_interfaces__action__Defend_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
uf_interfaces__action__Defend_FeedbackMessage__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
