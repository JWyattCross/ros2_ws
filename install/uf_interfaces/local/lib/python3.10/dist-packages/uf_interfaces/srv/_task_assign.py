...
class Metaclass_TaskAssign(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from uf_interfaces.srv import _task_assign
...
class TaskAssign(metaclass=Metaclass_TaskAssign):
    from uf_interfaces.srv._task_assign import TaskAssign_Request as Request
    from uf_interfaces.srv._task_assign import TaskAssign_Response as Response
